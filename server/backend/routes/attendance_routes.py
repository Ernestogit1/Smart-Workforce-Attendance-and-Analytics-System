...
from controllers.attendace_controller import today, time_in_view, time_out_view, history
...
urlpatterns = [
    ...
    path("attendance/history", require_firebase_auth(history), name="attendance_history"),
]